...
<div id="container">
    <div class="zhuce">
        <h1 class="h1-2  h1-3">密码找回</h1>
        <a href="login.php" class="back"><h4>< 返回</h4></a>
        <form action="Password_retireva.php" method="POST" enctype="multipart/form-data">
            <div class="zhuce-1">
            ...
            <div class="zhuce-1">
                <input type="password" placeholder="修改密码" name="PassWord" maxlength="24">
            </div>
            <div class="zhuce-1">
            ...
            <div class="zhuce-2 password-back-name">
            ...
            <div style="clear:both"></div>
            <div class="zhuce-5">
                <button type="submit" name="Submit" value="Retrieve"><h3>提交</h3></button>
            </div>
            <div class="zhuce-6">
...
if (isset($_POST['Submit']) && $_POST['Submit'] == 'Retrieve') {
    ...
    if (input_login_username_check($username,$alert) && input_login_password_check($password,$alert) && input_Registration_name_check($name,$alert) && input_Registration_phone_check($phone,$alert) && input_Registration_id_check($id,$alert) && input_Registration_mailbox_check($mailbox,$alert) && input_Registration_class_check($class,$alert)){
        ...
        //修改密码
        sql_Password_retireva($db,$username,$password,$name,$phone,$id,$mailbox,$class,$alert);
    }else{
        return session_destroy();
    }
}
